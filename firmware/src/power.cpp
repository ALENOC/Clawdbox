...
// ESP32-S3-BOX has no PMU/battery. Provide neutral stubs so the rest of
// the firmware compiles unchanged. ui_update_battery() interprets pct < 0
// as "no battery, hide icon".
