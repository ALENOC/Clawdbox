...
scan_for_device() {
    ...
    # Start LE scan
    # bluetoothctl in background with stdin closed exits immediately.
    # --timeout keeps it running synchronously for the full window.
    bluetoothctl --timeout 12 scan le &>/dev/null
